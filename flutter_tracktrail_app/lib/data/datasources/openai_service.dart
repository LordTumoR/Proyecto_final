              ...
              "content": [
                {
                  ...
                  "text": "Analiza esta imagen y devuélveme en formato JSON una lista de los alimentos que ves. Usa esta estructura por cada alimento:\n\n"
                      ...
                      "  \"brand\": \"Marca si es visible, si no pon sin marca\",\n"
                      "  \"category\": \"Categoría general (fruta, verdura, proteína, snack, etc)\",\n"
                      "  \"calories\": número o null (Si no las sabes estimacion aproximada),\n"
                      "  \"carbohydrates\": número o null(Si no las sabes estimacion aproximada),\n"
                      "  \"protein\": número o null(Si no las sabes estimacion aproximada),\n"
                      "  \"fat\": número o null(Si no las sabes estimacion aproximada),\n"
                      "  \"fiber\": número o null(Si no las sabes estimacion aproximada),\n"
                      "  \"sugar\": número o null(Si no las sabes estimacion aproximada),\n"
                      "  \"sodium\": número o null(Si no las sabes estimacion aproximada),\n"
                      "  \"cholesterol\": número o null(Si no las sabes estimacion aproximada),\n"
